...
class RiskBacktest:
    ...
    def calculate_etl(self, returns: np.ndarray, confidence_level: float = 0.95) -> float:
    ...
    def monte_carlo_simulation(self, historical_returns: np.ndarray) -> Dict:
    ...
    def run_comprehensive_backtest(self) -> Dict:
        ...
        metrics["historical_metrics"]["sharpe_ratio"] = self.calculate_sharpe_ratio(
            historical_returns
        )
        metrics["historical_metrics"]["sortino_ratio"] = self.calculate_sortino_ratio(
            historical_returns
        )
