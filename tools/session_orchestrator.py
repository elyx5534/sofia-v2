...
class SessionOrchestrator:
    ...
    def run_grid_session(self) -> Dict:
        ...
        try:
            ...
            result = subprocess.run(
                ...
                capture_output=True,
                text=True,
                timeout=self.grid_mins * 60 + 60,
                check=False,  # Extra minute for cleanup
            )
        ...
        try:
            ...
            if report_file.exists():
                ...
                return {
                    ...
                    "avg_latency_ms": (
                        latency.get("binance_avg_ms", 0) + latency.get("btcturk_avg_ms", 0)
                    )
                    / 2,
                }
            else:
    ...
    def run(self):
        ...
        print("Scorecard saved to: reports/daily_score.json")
...
def main():
    ...
    parser.add_argument(
        "--arb-mins", type=int, default=30, help="Arbitrage session duration (minutes)"
    )
