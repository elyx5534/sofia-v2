...
class PilotOff:
    ...
    def check_triggers(self) -> Dict:
        ...
        triggers = {"anomaly": False, "reconciliation": False, "drawdown": False, "manual": False}
    ...
    def emergency_stop(self, manual: bool = False) -> Dict:
        ...
        if manual:
            ...
            if trigger_check["any_triggered"]:
                ...
                return {"triggered": True, "triggers": trigger_check, "shutdown": result}
            else:
                return {"triggered": False, "message": "No triggers detected"}
    ...
    def status(self) -> Dict:
        """Check pilot status"""
        status = {"pilot_enabled": False, "triggers_active": {}, "last_shutdown": None}
...
def main():
    ...
    parser.add_argument("action", choices=["stop", "check", "status"], help="Action to perform")
    parser.add_argument("--manual", action="store_true", help="Manual emergency stop")
