        ...
        for hour in range(0, 12):
            ...
            if hour == 0:
                ...
                task = {
                    ...
                    'commands': [
                        'python run_paper_session.py 60'
                    ],
                    'targets': {
                        'trades': '> 20',
                        'fill_rate': '> 50%'
        ...
        for hour in range(12, 24):
            ...
            if hour % 2 == 0:
                task = {
                    ...
                    'commands': [
                        'python run_paper_session.py 90'
                    ],
                    'targets': {
                        'trades': '> 30',
                        'fill_rate': '> 55%'
        ...
        for hour in range(24, 48):
            ...
            if hour % 4 == 0:
                ...
                task = {
                    ...
                    'commands': [
                        'python run_paper_session.py 120'
                    ],
                    'targets': {
                        'trades': '> 40',
                        'pnl': 'positive'
        ...
        for hour in range(48, 72):
            ...
            if hour == 48:
                ...
                task = {
                    ...
                    'commands': [
                        'python tools/pilot_decision.py'
                    ],
                    'targets': {
                        'decision': 'GO/NO-GO',
                        'confidence': '> 80%'
                ...
                task = {
                    ...
                    'commands': [
                        'echo "Configure live API keys"',
                        'echo "Set pilot limits"'
                    ],
                    'targets': {
                        'api_keys': 'configured',
                        'limits': 'set'
    ...
    def save_markdown_report(self, report: Dict):
        ...
        with open(md_file, 'w') as f:
            ...
            for item in report['readiness_summary']['items']:
                ...
                f.write(f"| {item['metric']} | {item['current']:.1f} | {item['target']} | {status} |\n")
