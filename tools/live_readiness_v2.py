...
def assess_readiness() -> Dict:
    ...
    go_decision = (
        criteria["last_3_sessions_all_pass"]
        and criteria["shadow_avg_diff_bps_p95"]
        and criteria["consistency_pass"]
        and criteria["dd_within_1pct"]
        and criteria["min_3_sessions"]
        and criteria["uptime_above_99pct"]
    )
