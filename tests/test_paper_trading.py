...
from src.paper.signal_hub import Signal, SignalHub
...
class TestRiskIntegration:
    ...
    async def test_pre_trade_risk_check(self):
        ...
        # Create a signal
        signal = {"symbol": "BTC/USDT", "strength": 0.8, "confidence": 0.7}
...
class TestMLIntegration:
    ...
    def test_ml_weight_application(self):
        ...
        # Mock fused signal
        fused_signal = {"strength": 0.6, "confidence": 0.7}
...
class TestEndToEndFlow:
    ...
    async def test_full_trading_cycle(self):
        ...
        await runner._create_paper_order(
            symbol="BTC/USDT", side="buy", quantity=Decimal("0.01"), price=current_price
        )
        ...
        # Process sell signal
        await runner._create_paper_order(
            symbol="BTC/USDT", side="sell", quantity=Decimal("0.01"), price=Decimal("51000")
        )
