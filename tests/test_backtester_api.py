...
class TestBacktesterAPI:
    ...
    def test_backtest_endpoint_success(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_with_custom_params(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_with_date_range(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_symbol_not_found(self, mock_data_adapter):
        ...
        response = client.get("/backtester/backtest?symbol=INVALID&asset_type=equity&strategy=sma")
    ...
    def test_backtest_endpoint_data_fetch_error(self, mock_data_adapter):
        ...
        response = client.get("/backtester/backtest?symbol=AAPL&asset_type=equity&strategy=sma")
    ...
    def test_backtest_endpoint_comprehensive_response_format(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_different_timeframes(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_different_asset_types(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
        """Test backtest endpoint with different asset types"""
        test_cases = [("AAPL", "equity"), ("BTC/USDT", "crypto")]
    ...
    def test_backtest_endpoint_parameter_parsing(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_edge_cases(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_special_characters_in_symbol(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_concurrent_requests(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_memory_efficiency(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
    ...
    def test_backtest_endpoint_error_recovery(self, mock_data_adapter):
        ...
        response1 = client.get("/backtester/backtest?symbol=AAPL&asset_type=equity&strategy=sma")
    ...
    def test_backtest_endpoint_data_validation(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
...
class TestBacktesterAPIIntegration:
    ...
    def test_strategy_parameter_effects(
        self, mock_data_adapter, mock_backtest_engine, mock_calculate_metrics
    ):
