...
class TestDataExchanges:
    ...
    def test_fetch_ticker(self):
        ...
        manager = ExchangeManager()
        with patch.object(manager, 'exchange', Mock(fetch_ticker=Mock(return_value={'last': 50000}))):
...
class TestScanRules:
    ...
    def test_rule_evaluation(self):
        ...
        rule = ScanRule(
            name="test_rule",
            condition=lambda x: x['price'] > 50000,
            action="buy"
        )
...
class TestScanScanner:
    ...
    def test_scan_symbols(self):
        ...
        data = [
            {'symbol': 'BTC', 'volume': 2000000},
            {'symbol': 'ETH', 'volume': 500000}
        ]
...
class TestNewsAggregator:
    ...
    def test_fetch_news(self, mock_requests):
        ...
        mock_requests.get.return_value = Mock(
            json=Mock(return_value={'articles': []})
        )
