...
def test_grid_signals_generation(grid_config, sample_data):
    ...
    tick = {"symbol": "BTCUSDT", "price": 50000, "bid": 49990, "ask": 50010, "volume": 100}
...
def test_inventory_management(grid_config):
    ...
    buy_order = {"side": "buy", "quantity": 0.01, "price": 49500, "order_id": "test1"}
    ...
    strategy.inventory = (
        grid_config["max_inventory"] * grid_config["rebalance_threshold"] / 50000 + 0.001
    )
...
def test_cooldown_period(grid_config):
    ...
    tick = {"symbol": "BTCUSDT", "price": 50000, "bid": 49990, "ask": 50010}
