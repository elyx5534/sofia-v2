...
class TestBacktesterAPIComponents:
    ...
    def test_metrics_calculation_import(self):
        ...
        trades = [
            {"timestamp": datetime.now(), "type": "buy", "price": 100, "quantity": 10, "value": 1000, "commission": 1},
            {"timestamp": datetime.now(), "type": "sell", "price": 103, "quantity": 10, "value": 1030, "commission": 1}
        ]
