...
def test_portfolio_mechanics(mock_datahub):
    ...
    from src.services.backtester import Portfolio, BacktestConfig
...
def test_strategies(mock_datahub):
    ...
    from src.services.backtester import SMAStrategy, RSIStrategy, BreakoutStrategy
    import pandas as pd
    import numpy as np
...
def test_backtester_integration():
    ...
    with patch('src.services.datahub.datahub') as mock_datahub:
        ...
        for i in range(100):
            ...
            mock_data.append([
                timestamp, price, price + 50, price - 50,
                price + (i % 3 - 1) * 10, 1000 + i * 10
            ])
