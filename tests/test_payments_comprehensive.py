...
class TestStripeClient:
    ...
    def test_create_customer(self, mock_create):
        ...
        mock_create.return_value = {"id": "cus_test123", "email": "test@example.com"}

        client = StripeClient()
        customer = client.create_customer(email="test@example.com", name="Test User", user_id=1)
    ...
    def test_create_checkout_session(self, mock_create):
        ...
        mock_create.return_value = {"id": "cs_test123", "url": "https://checkout.stripe.com/test"}
    ...
    def test_cancel_subscription(self, mock_cancel):
        ...
        mock_cancel.return_value = {"id": "sub_test123", "status": "canceled"}
...
class TestPaymentRouter:
    ...
    def test_create_checkout_session_endpoint(self, mock_stripe, mock_get_db):
        ...
        response = client.post(
            "/create-checkout-session", json={"price_tier": "basic", "billing_interval": "month"}
        )
...
class TestWebhookHandlers:
    ...
    async def test_handle_checkout_completed(self, mock_stripe):
        ...
        session = {"metadata": {"user_id": "1"}, "subscription": "sub_test123"}
