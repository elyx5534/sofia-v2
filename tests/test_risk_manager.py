...
class TestRiskParameters:
    ...
    def test_risk_parameters_field_descriptions(self):
        ...
        assert "Max position size as % of portfolio" in str(
            schema["properties"]["max_position_size"]
        )
