...
class TestPortfolioManager:
    ...
    def test_update_position(self, portfolio_manager):
        ...
        # Update position
        updated = portfolio_manager.update_position(
            "BTC/USDT",
            current_price=52000
        )
    ...
    def test_get_position_size(self, portfolio_manager):
        ...
        size = portfolio_manager.get_position_size(
            symbol="BTC/USDT",
            price=50000,
            stop_loss=48000
        )
...
class TestAssetAllocator:
    ...
    def test_mean_variance_optimization(self, allocator):
        ...
        allocations = allocator.mean_variance_optimization(
            returns,
            target_return=0.001
        )
    ...
    def test_black_litterman_allocation(self, allocator):
        ...
        allocations = allocator.black_litterman_allocation(
            market_caps,
            views
        )
    ...
    def test_correlation_adjusted_allocation(self, allocator):
        ...
        adjusted = allocator.adjust_for_correlation(
            base_allocations,
            correlations
        )
    ...
    def test_allocation_constraints(self, allocator):
        ...
        allocations = allocator.constrained_allocation(
            min_allocations,
            max_allocations
        )
