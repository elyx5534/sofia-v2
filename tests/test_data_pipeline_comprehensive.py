...
class TestDataPipeline:
    ...
    def test_fetch_universe_data(self, mock_fetch, sample_ohlcv_data):
        ...
        with patch("src.data.pipeline.UNIVERSE_SYMBOLS", ["BTC-USD", "ETH-USD"]):
            results = pipeline.fetch_universe_data(timeframes=["1h"], days_back=7, max_workers=2)
...
class TestDataIntegration:
    ...
    def test_pipeline_with_exchanges(self, mock_ex_binance, mock_pip_binance):
        ...
        mock_exchange.fetch_ohlcv.return_value = [[1234567890000, 45000, 46000, 44000, 45500, 100]]
        mock_exchange.fetch_ticker.return_value = {"last": 45500, "volume": 1000}
