...
class TestArbitragePricer:
    ...
    def test_calculate_arbitrage_profit_profitable(self, pricer):
        ...
        binance_book = {
            'asks': [[40000, 10]],  # Buy BTC at $40k
            'bids': [[39990, 10]]
        }
        
        btcturk_book = {
            'bids': [[1400000, 10]],  # Sell BTC at 1.4M TL
            'asks': [[1400100, 10]]
        }
        
        fx_rate = 34.0  # USDTRY
        
        result = pricer.calculate_arbitrage_profit(
            binance_book, btcturk_book, 1000, fx_rate
        )
    ...
    def test_calculate_arbitrage_no_depth(self, pricer):
        ...
        result = pricer.calculate_arbitrage_profit(
            binance_book, btcturk_book, 1000, 34.0
        )
    ...
    def test_find_optimal_size(self, pricer):
        ...
        result = pricer.find_optimal_size(
            binance_book, btcturk_book, 34.0, max_size=5000
        )
