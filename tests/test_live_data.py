...
class TestLiveDataService:
    ...
    def test_get_live_price_success(self, mock_ticker):
        ...
        mock_history = pd.DataFrame({"Close": [50000, 51000], "Volume": [1000000, 1100000]})
    ...
    def test_get_multiple_prices(self, mock_tickers):
        ...
        mock_btc.history.return_value = pd.DataFrame({"Close": [50000, 51000]})
        mock_eth.history.return_value = pd.DataFrame({"Close": [3000, 3100]})

        mock_instance.tickers = {"BTC-USD": mock_btc, "ETH-USD": mock_eth}
    ...
    def test_get_crypto_fear_greed_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "data": [{"value": "75", "value_classification": "Greed", "timestamp": "1640995200"}]
        }
    ...
    def test_get_market_summary(self):
        ...
        with (
            patch.object(self.service, "get_multiple_prices") as mock_prices,
