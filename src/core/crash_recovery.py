...
class SystemState:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'last_processed_data': {
                k: v.isoformat() for k, v in self.last_processed_data.items()
            },
    ...
    def from_dict(cls, data: Dict) -> 'SystemState':
        ...
        return cls(
            ...
            last_processed_data={
                ...
                for k, v in data['last_processed_data'].items()
            },
        ...
        try:
            ...
            for symbol, position in state.active_positions.items():
                try:
                    ...
                    report['errors'].append(f"Position {symbol}: {str(e)}")
            ...
            for order in state.pending_orders:
                try:
                    ...
                    report['errors'].append(f"Order {order['id']}: {str(e)}")
            ...
            for strategy in state.running_strategies:
                try:
                    ...
                    report['errors'].append(f"Strategy {strategy}: {str(e)}")
...
# Helper functions
async def create_system_snapshot(trading_engine, 
                                portfolio_manager,
                                strategy_engine) -> SystemState:
    """
