...
class StripeClient:
    ...
    def create_customer(self, email: str, name: str, user_id: int) -> Dict[str, Any]:
        ...
        try:
            customer = stripe.Customer.create(
                email=email, name=name, metadata={"user_id": user_id, "platform": "sofia_v2"}
            )
    ...
    def create_checkout_session(
        self, customer_id: str, price_id: str, success_url: str, cancel_url: str, user_id: int
    ) -> Dict[str, Any]:
    ...
    def create_promotional_code(self, coupon_id: str, code: str) -> Dict[str, Any]:
        ...
        try:
            promo_code = stripe.PromotionCode.create(
                coupon=coupon_id, code=code, active=True, max_redemptions=100
            )
