...
class FundingFarmerV2:
    ...
    def __init__(self, config: Dict = None):
        ...
        self.borrow_rate_annual = Decimal(str(config.get("borrow_rate_annual", 0.1)))
    ...
    def get_funding_rates(self) -> Dict[str, Decimal]:
        ...
        rates = {
            "BTCUSDT_PERP": Decimal("0.0015"),
            "ETHUSDT_PERP": Decimal("0.0012"),
            "SOLUSDT_PERP": Decimal("0.0020"),
            "BNBUSDT_PERP": Decimal("0.0008"),
        }
        return rates
    ...
    def calculate_borrow_cost_hourly(self, position_value: Decimal) -> Decimal:
        ...
        hourly_rate = self.borrow_rate_annual / Decimal("8760")
    ...
    def run_cycle(self) -> Dict:
        ...
        for symbol in list(self.positions.keys()):
            ...
            if current_rate * Decimal("10000") < Decimal("5"):
