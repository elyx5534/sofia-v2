...
class ArbTLRadar:
    ...
    def start_radar(self, mode: str = "tl", pairs: List[str] = None, threshold_bps: int = 50) -> Dict:
    ...
    def _save_results(self):
        ...
        summary = {
            ...
            "num_opportunities": len(self.opportunities),
            "num_trades": len(self.paper_trades),
            "avg_profit_per_trade": float(self.total_pnl_tl / len(self.paper_trades)) if self.paper_trades else 0,
        ...
        logger.info(f"Saved arbitrage results: {len(self.paper_trades)} trades, {self.total_pnl_tl:.2f} TL profit")
