...
class AdaptiveController:
    ...
    def __init__(self):
        self.target_fill_rate = 0.6
        self.target_shadow_diff = 5.0
        self.history_sessions = 3
    ...
    def calculate_adjustments(self, fill_rate: float, shadow_diff: float) -> Dict:
        ...
        if config_file.exists():
            ...
            current_config = {"step_in_k": 1, "min_edge_bps": 5}
        ...
        elif fill_rate > 0.7 or shadow_diff > 6:
    ...
    def log_changes(self, adjustments: Dict):
        ...
        if log_file.exists():
            ...
            log = []
        entry = {"timestamp": datetime.now().isoformat(), "adjustments": adjustments}
        log.append(entry)
        log = log[-100:]
    ...
    def run(self) -> Dict:
        ...
        print("=" * 60)
        return {
            "metrics": {"fill_rate": fill_rate, "shadow_diff": shadow_diff},
