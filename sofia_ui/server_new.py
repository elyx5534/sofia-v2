...
async def backtest(request: Request):
    ...
    return templates.TemplateResponse(
        ...
        {"request": request, "current_page": "backtest", "page_title": "Backtest - Sofia V2"},
    )
...
async def strategies(request: Request):
    ...
    return templates.TemplateResponse(
        "clean_dashboard.html",
        {"request": request, "current_page": "strategies", "page_title": "Strategies - Sofia V2"},
    )
...
async def trade_ai(request: Request):
    ...
    return templates.TemplateResponse(
        "dashboard.html",
        {"request": request, "current_page": "ai_trading", "page_title": "AI Trading - Sofia V2"},
    )
...
async def reliability(request: Request):
    ...
    return templates.TemplateResponse(
        "dashboard.html",
        {"request": request, "current_page": "reliability", "page_title": "Reliability - Sofia V2"},
    )
...
async def settings(request: Request):
    ...
    return templates.TemplateResponse(
        "dashboard.html",
        {"request": request, "current_page": "settings", "page_title": "Settings - Sofia V2"},
    )
...
async def showcase(request: Request, symbol: str):
    ...
    tv_symbol_map = {"BTC": "BINANCE:BTCUSDT", "ETH": "BINANCE:ETHUSDT", "AAPL": "NASDAQ:AAPL"}
...
async def bist(request: Request):
    ...
    return templates.TemplateResponse(
        "dashboard.html",
        {"request": request, "current_page": "bist", "page_title": "BIST - Sofia V2"},
    )
...
async def trading_bot(request: Request):
    ...
    return templates.TemplateResponse(
        "trading_bot.html",
        {"request": request, "current_page": "trading_bot", "page_title": "Trading Bot - Sofia V2"},
    )
