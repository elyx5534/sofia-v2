...
class TimescaleStore:
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.engine = create_async_engine(
                self.database_url, pool_size=10, max_overflow=20, pool_pre_ping=True, echo=False
            )
            ...
            self.connection_pool = await asyncpg.create_pool(
                self.database_url.replace("+asyncpg", ""), min_size=5, max_size=20
            )
    ...
    async def _flush_orderbooks(self):
        ...
        try:
            ...
            logger.debug(
                "Flushed orderbook snapshots to TimescaleDB", count=len(self.orderbook_buffer)
            )
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            and not self.connection_pool.closed(),
            "buffer_sizes": {
