...
from sofia_backtest.paper.engine import Order, OrderSide, PaperTradingEngine
...
class PaperTradingRunner:
    ...
    async def initialize(self):
        ...
        await self.engine.initialize(self.nats_client, self.redis_client, self.ch_url)
        ...
        async def handle_tick(msg):
            ...
            try:
                ...
                for signal in signals:
                    ...
                    if success:
                        logger.info(
                            f"Order submitted: {signal.symbol} {signal.signal_type.value} "
